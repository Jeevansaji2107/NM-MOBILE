...
export const categories: Category[] = [
  {
    ...
    subcategories: [
      ...
      { id: '1-3', name: 'Camera Body', status: 'active', createdAt: '2024-01-15' },
      { id: '1-4', name: 'Camera Lens', status: 'active', createdAt: '2024-01-15' },
      { id: '1-5', name: 'Gaming Console', status: 'active', createdAt: '2024-01-15' },
...
const skinsProductNames = ['Transparent', 'Plain', 'Premium Matte', 'Premium Embossed'];
...
casesSubcategories.forEach((sub) => {
  casesProductNames.forEach((name) => {
    ...
    const tags = ['case', sub.name.toLowerCase(), name.toLowerCase().split(' ')[0]];
...
spSubcategories.forEach((sub) => {
  spProductNames.forEach((name) => {
    ...
    const tags = ['screen-protector', sub.name.toLowerCase(), name.toLowerCase()];
